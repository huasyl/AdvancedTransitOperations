...
namespace RapidTransitMod
{
    public partial class DepartureControlSystem
    {
        ...
        private sealed class RuntimeObservationSession
        {
            ...
            public readonly List<RuntimeObservedCorridorPassageDto> CorridorPassages = new List<RuntimeObservedCorridorPassageDto>();
        }
        ...
        private sealed class RuntimeObservedStopEvent
        {
        ...
        private sealed class RuntimeObservedBypassEvent
        {
            public string EventId = string.Empty;
