...
function BusIcon() {
  return (
    <svg className="rtw-overview-mode-svg" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M15 6v6" />
      <path d="M2 12h19.6" />
      <path d="M18 18h3s.5 0 .5-.5v-5.5c0-3.9-3.1-7-7-7H9.6c-3.9 0-7 3.1-7 7v5.5c0 .5.5.5.5.5h3" />
