...
namespace RapidTransitMod.TrackModel
{
    ...
    {
        internal void EnsureTrackChainBypassPipelineReady(LineTrackChain chain)
        {
            if (chain == null)
                return;

            EnsureSharedTrackIndexCurrent();
            if (chain.BypassPipelineReadyVersion == SharedIndexVersion
        ...
        private void RefreshProtectedIntervalSummaries(LineTrackChain chain)
        {
            ...
            if (chain.BypassProtectedIntervals.Count == 0)
            {
                ...
                chain.BypassPipelineReadyVersion = chain.SharedRunsVersion == SharedIndexVersion ? SharedIndexVersion : 0;
                return;
            }
        ...
        internal bool TryGetLocalBypassSceneStaticSnapshot(
            Entity line,
            DynamicBuffer<RouteWaypoint> waypoints,
            int currentWaypointIndex,
        ...
        internal bool TryGetLocalSceneDefinition(
            Entity line,
            DynamicBuffer<RouteWaypoint> waypoints,
            int currentWaypointIndex,
            out LineTrackChain chain,
        ...
        internal bool TryGetForwardStationExitCoordinate(
        ...
        internal bool TryGetForwardStationExitAtomIndex(
            LineTrackChain localChain,
            BypassProtectedInterval localProtectedInterval,
            Entity currentBypassBuilding,
