...
namespace RapidTransitMod
{
    public sealed class OriginArrivingStallRepairSystem : GameSystemBase
    {
            ...
            out RejectDiagnostic reject)
        {
            ...
            int waypointIndex = control.ComputeWaypointIndexForOriginArrivingRepair(vehicle, waypoints);
            reject.WaypointIndex = waypointIndex;
            bool routeProgressAtOrigin = control.TryGetOriginArrivalRouteProgressForOriginArrivingRepair(
                vehicle,
