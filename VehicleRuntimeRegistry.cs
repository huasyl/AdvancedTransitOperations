...
{
    internal sealed class VehicleRuntimeRegistry
    {
        private readonly VehicleRuntimeStateStore m_Store;

        public VehicleRuntimeRegistry(VehicleRuntimeStateStore store)
        {
            m_Store = store;
        }
