...
{
    internal struct SelectionPanelLineData
    {
    ...
    internal struct SelectionPanelVehicleData
    {
    ...
    internal sealed class SelectionPanelQuery
    {
        ...
        public SelectionPanelQuery(
            EntityManager entityManager,
            TimeSystem timeSystem,
            SimulationSystem simulationSystem,
            VehicleRuntimeView vehicleView,
        ...
        public bool TryLine(Entity selectedEntity, Entity preferredRoute, out SelectionPanelLineData data)
        {
            data = default;
            ...
            data = new SelectionPanelLineData
            {
        ...
        public bool TryVehicle(Entity selectedEntity, out SelectionPanelVehicleData data)
        {
            data = default;
            ...
            data = new SelectionPanelVehicleData
            {
                Vehicle = vehicle,
                Line = line,
                NowMin = nowMin,
